...
namespace Grocery {
    ...
    public partial class GroceryDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProductRow AddProductRow(string id, int supplier_id, string name, string description, double price) {
...
namespace Grocery.GroceryDataSet1TableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Product] WHERE (([id] = @Original_id) AND ([supplier_id] = @Original_supplier_id) AND ([name] = @Original_name) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)) AND ([price] = @Original_price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Product] ([id], [supplier_id], [name], [description], [price])" +
                " VALUES (@id, @supplier_id, @name, @description, @price);\r\nSELECT id, supplier_i" +
                "d, name, description, price FROM Product WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [id] = @id, [supplier_id] = @supplier_id, [name] = @name, [description] = @description, [price] = @price WHERE (([id] = @Original_id) AND ([supplier_id] = @Original_supplier_id) AND ([name] = @Original_name) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)) AND ([price] = @Original_price));
SELECT id, supplier_id, name, description, price FROM Product WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Grocery.Properties.Settings.Default.GroceryConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, supplier_id, name, description, price FROM dbo.Product";
        ...
        public virtual int Delete(string Original_id, int Original_supplier_id, string Original_name, string Original_description, double Original_price) {
            if ((Original_id == null)) {
        ...
        public virtual int Insert(string id, int supplier_id, string name, string description, double price) {
            if ((id == null)) {
        ...
        public virtual int Update(string id, int supplier_id, string name, string description, double price, string Original_id, int Original_supplier_id, string Original_name, string Original_description, double Original_price) {
            if ((id == null)) {
                throw new global::System.ArgumentNullException("id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int supplier_id, string name, string description, double price, string Original_id, int Original_supplier_id, string Original_name, string Original_description, double Original_price) {
            return this.Update(Original_id, supplier_id, name, description, price, Original_id, Original_supplier_id, Original_name, Original_description, Original_price);
        }
    }
